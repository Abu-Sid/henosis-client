...
const Testimonial = () => {
  ...
  return (
    <div className="testimonial">
      <h1 data-aos="fade-up">
        Our Client <span data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">Testimonials</span>{" "}
      </h1>
      <div className="testimonial__container">
          <div style={CONTAINER_STYLE}>
            <ReactCardCarousel autoplay={true} autoplay_speed={3500}>
              {TestimonialData.testimonials.map((test) => (
                <div key="test.name" style={CARD_STYLE} className="testimonial__container__card">
                  <img
                    src={test.image}
                    alt=""
                  />
